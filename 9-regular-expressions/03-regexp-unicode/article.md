...
## کتابخانه ها
 کتابخانه ها به مدیریت یونیکد در جاوا اسکریپت کمک می کنند:


 در [XRegExp](https://xregexp.com/) که یک کتابخانه عبارات معمولی است و دارای یک افزونه رسمی برای تطبیق دسته‌ها، اسکریپت‌ها، بلوک‌ها و ویژگی‌های یونیکد است، از طریق یکی از دو ساختار زیر ساخته میشود:
- اولین ساختار:  \p{...} \p{^...} \P{...}
 
برای مثال، \p{Letter} با حروف الفبای مختلف مطابقت دارد در حالی که \p{^Letter} و \P{Letter} هر دو با سایر نقاط کد مطابقت دارند. [این مقاله](https://exploringjs.com/es5/ch30.html)شامل یک نمای کلی از XRegExp است.


- دومین ساختار: API بین‌المللی‌سازی ECMAScript که می توان به [API بین‌المللی‌سازی ECMAScript](https://exploringjs.com/es5/ch30.html#i18n_api) مراجعه کرد، ترکیب‌بندی آگاه از یونیکد (مرتب‌سازی و جستجوی رشته‌ها) و موارد دیگر را فراهم می‌کند.
