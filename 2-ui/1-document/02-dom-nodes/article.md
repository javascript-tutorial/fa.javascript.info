...
طبق مدل Document Object (DOM)، هر تگ HTML یک شی است. تگ‌های داخلی "فرزندانِ" تگ‌های دربرگیرنده هستند. متن داخل تگ نیز یک شی است.
...
```online
در تصویر بالا، می‌توانیم روی گره‌های عنصر کلیک کنید و فرزندان آنها باز می‌شوند.
```
