...
در زمان های قدیم، ویژگی پارامترهای اضافی در زبان جاوااسکریپت وجود نداشت و استفاده از "arguments" تنها راه بدست آوردن همه آرگومان‌های تابع بود. و هنوز کار می کند، می توانیم آن را در کدهای قدیمی پیدا کنیم.
...
همچنین همیشه شامل همه آرگومان‌ها است. ما نمی‌توانیم تعداد مشخصی از آنها را به دست بیاوریم، مانند کاری که با پارامتر‌های اضافی کردیم.
...
همانطور که به خاطر داریم ، توابع تک خطی از خود `this` ندارند. اکنون می دانیم که آنها آبجکت `arguments` خاصی نیز ندارند.
...
هنگامی که در کد `" ... "` را می‌بینیم، این عبارت یا پارامتر های اضافی است یا سینتکس گسترش.
