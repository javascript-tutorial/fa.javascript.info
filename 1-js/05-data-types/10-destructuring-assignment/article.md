...
- شیءها به ما این امکان را می‌دهند تا چیزی بسازیم که داده‌ها را به واسطه کلید ذخیره کند.
...
```
این کار می‌کند چون از درون، یک مقداردهی تجزیه‌کننده‌ی ساختار با حلقه زدن در مقدار سمت راست تساوی کار می‌کند. برای فراخوانی `for..of` در مقدار سمت راست `=` و تخصیص دادن مقدارها، به نوعی خوش سینتکس است.
````


````smart header="در سمت چپ به هر چیزی تخصیص دهید"
ما می‌توانیم از هر چیز «قابل مقداردهی‌» در سمت چپ استفاده کنیم.
...
مقدار `rest` آرایه‌ای از المان‌های باقی مانده در آرایه است.
...
ما باید یک شیء موجود که می‌خواهیم آن را در چند متغیر پخش کنیم در سمت راست داشته باشیم. سمت چپ، یک «الگوی» شیء مانند برای ویژگی‌های متناظر را شامل می‌شود. در ساده‌ترین حالت، یک لیست از اسم‌های متغیر در `{...}` است.
