...
-خیلی کارها هستند که یک نفر بخواهد با داده‌های اصلی مثل رشته حروف یا اعداد انجام دهد. اگر دسترسی به آن‌ها به عنوان متد باشد عالی می‌شود.
- مقدارهای اصلی تا جای امکان سریع و سبک باشند.
