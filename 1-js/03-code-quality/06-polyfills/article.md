...
حالا که صحبت از اسم‌ها شد، [Babel](http://babeljs.io/) یکی از برجسته‌ترین ترنسپایلرهای موجود  است.
...
جاوااسکریپت یک زبان به‌شدت داینامیک است. اسکریپت‌ها می‌توانند هر تابعی را تغییر دهند یا اضافه کنند. حتی تابع‌های درون‌ساخت.
...
- [polyfill.io](http://polyfill.io) سرویسی که براساس فیچرها و مرورگر کاربر یک اسکریپت با پلیفیل‌ها ارائه می‌دهد.
...
فراموش نکنید که از یک ترنسپایلر (اگر از سینتکس یا عملگرهای مدرن استفاده می‌کنید) و پلیفیل‌ها (برای اضافه کردن تابع‌هایی که ممکن است موجود نباشند) استفاده کنید. با این کار مطمئن خواهید بود که کد شما کار می‌کند.

برای مثال، بعدها که با جاوااسکریپت آشنایی بیشتری پیدا کنید، می‌توانید یک سیستم build کد بر پایه [webpack](https://webpack.js.org/) و پلاگین [babel-loader](https://github.com/babel/babel-loader) راه‌اندازی کنید.
