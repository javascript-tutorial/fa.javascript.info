...
براکت‌ها قدرت بسیار بیشتری نسبت به نقطه دارند. آنها هر نوع اسم ویژگی و متغیر را ممکن می‌سازند. اما آنها برای نوشتن دشوارتر هستند.
...
بنابراین "49" یک اسمِ ویژگی از نوع عدد صحیح است، چون زمانی که به یک عدد صحیح تبدیل می‌شود و برعکس، هنوز یکسان است. اما "49+" و "1.2" اینطور نیستند:

```js run
// به طور واضح به یک عدد تبدیل می‌کند Number(...)
